...
where: { 
    ...
    data: {
      prd_re_ord: prd_re_ord ? new Prisma.Decimal(prd_re_ord) : 0,
      max_pur_qty: Number(max_pur_qty),
      prd_lot_ref: prd_lot_ref,
      exp_dt: new Date(exp_dt)
//      max_pur_qty: max_pur_qty ? new Prisma.Decimal(String(max_pur_qty)) : null,
