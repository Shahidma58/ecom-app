...
export default function Tran_Footer() {
  const { totals, finalizeSale, items, updStorePaidAmt, setCustomerMobile } =
    usePurchaseStore();
  ...
  return (
    <>
      <div className="bg-linear-to-r from-emerald-700 to-teal-600 text-white rounded-lg shadow-lg px-1 py-1 sticky bottom-0 mt-auto">
        <div className="flex grid-cols-7 gap-2 justify-center items-center">
          {/* ITEMS */}
          ...
          <div className="flex flex-col w-35">
            ...
            <div className="bg-white/95 rounded-md p-1 text-center">
              <input
                ...
                className="w-full text-emerald-700 text-center text-base focus:outline-none"
                step="0.01"
                min="0"
              />
            </div>
