...
//        alert(err.message);
  ...
  return (
    <>
      <Head>
        <title>Transfer Products to Other Branch</title>
      </Head>
        ...
        <div className="max-w-2xl mx-auto">
          <header className="mb-1 rounded-lg shadow-md p-2 text-center bg-linear-to-r from-green-600 via-emerald-600 to-teal-600">
            <h1 className="text-2xl font-bold text-white tracking-wide">
              Transfer Products to Other Branch
            </h1>
          </header>
              ...
              <div className="grid grid-cols-[25%_25%_40%] gap-2 border-b">  
                ...
                <div>
                  <input
                    ...
                    value={form.brn_cd}
//                    onChange={handleChange}
                    className="w-25 border border-black rounded px-3 py-2 text-sm"
                    disabled
                  />
                </div>
                <div>
              ...
              {/* Display Purch Price & MAx Retl Price */}
              <div className="grid grid-cols-[25%_25%_25%_25%] gap-2 border-b">
                  {/* <div className={"mr-1"}>Purchase Price:</div>
                  <div>
                    <input
                      type="number"
                      name="pur_prc"
              ...
              <div className="grid grid-cols-[25%_25%_25%_25%] gap-2 border-b">              
                <div className={"mr-5"}>Transfer Qty: </div>
                <div>
                    <input
                      type="number"
                      name="xfr_qty"
