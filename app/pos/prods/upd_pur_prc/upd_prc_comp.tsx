  ...
  return (
    <>
      ...
      >
        {/* Modal Content */}
        <div 
          className="bg-white rounded-lg shadow-2xl border-2 border-gray-300 w-[500px] max-h-[90vh] overflow-auto"
          ...
          <main className="p-4">
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div className="flex gap-3 justify-center pt-2 border-t border-gray-300">
                ...
                <button
                  className="flex items-center gap-2 bg-gray-500 hover:bg-gray-600 text-white font-semibold py-2 px-6 rounded-md shadow-md transition-all"
                  type="button"
                  onClick={onClose}
                >
                  ✕ Close
